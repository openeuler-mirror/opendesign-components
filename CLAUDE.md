...
- 若你是Claude Code，本项目的所有 AI 技能统一存放在：**./.agents/skills/**
- 若你发现项目下有`skills-lock.json`但是没有找到skills，那你应该在项目根目录运行`pnpx skills experimental_install`以安装他们，然后再看问题中是否有命中的skills
