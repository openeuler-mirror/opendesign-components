...
5. 锚点嵌套：`OAnchorItem` 可以嵌套使用，形成多级锚点结构
...
5. Nested anchors: `OAnchorItem` can be nested to create multi-level anchor structures
</docs>
