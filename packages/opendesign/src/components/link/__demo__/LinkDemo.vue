...
<template>
  ...
  <section>
    ...
    <OLink :href="link" status="primary">高亮链接</OLink>
  ...
  <section>
    ...
    <OLink status="primary">primary链接</OLink>
    <OLink status="primary" hoverable>hoverable</OLink>
    <OLink status="warning">warning链接</OLink>
    <OLink status="warning" hoverable>hoverable</OLink>
    <OLink status="danger">danger链接</OLink>
    <OLink status="danger" hoverable>hoverable</OLink>
    <OLink status="success">success链接</OLink>
    <OLink status="success" hoverable>hoverable</OLink>
  </section>
  <h4>点击事件</h4>
  <section>
