...
| \-\-option-list-max-height-default ^[1.2.7](primary) | Default max height of the option list in virtual scroll mode                |

### Internal CSS Classes

| Class                       | Description                                                            |
| --------------------------- | ---------------------------------------------------------------------- |
| `.o-sr-only`                | Screen reader-only hidden text node, visually zero impact @since 1.2.7 |
| `.o-select-native-fallback` | Native select fallback element, always rendered @since 1.2.7           |
