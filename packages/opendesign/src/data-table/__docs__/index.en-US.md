...
| description         | string \| Component \| VNode                                                                                               | ''                                                          |          | Descriptive text for header, shown as tooltips and supports VNode passing.                                                     |
...
| showOverflowToolTip | boolean \| number                                                                                                          | false                                                       |          | Whether to hide overflow and show a tooltip when exceeding the maximum width. Pass a number to set the maximum number of lines |
| sortKey             | string                                                                                                                     | undefined                                                   |          | Key for the value passed to the parameter object on sort trigger                                                               |
| filter              | [DataTableColumnFilterT](#data-table-column-filter-t)                                                                      | undefined                                                   |          | Filter-related configuration including options                                                                                 |
| customColSpan       | number                                                                                                                     | undefined                                                   |          | Custom colspan for header cells: only supports merging among same-level siblings                                               |
